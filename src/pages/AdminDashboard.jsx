 ...
 * Navigation to admin tools is handled in DashboardShell.
 */
export default function AdminDashboard() {
  ...
  const serviceSummaryItems = [
    ...
    ["Confirmed Tickets", summary?.confirmedCount ?? "-"],
    ["Waiting List", summary?.waitingCount ?? "-"],
    ["Cancelled Tickets", summary?.cancelledCount ?? "-"],
    ...
    <DashboardShell>
      ...
      >
        ...
        <div className="relative z-10">
          ...
          >
            Monitor today’s confirmed tickets, waiting list, cancellations,
            available seats, and user activity for the staff bus service.
          </p>
      ...
      >
        <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          ...
          >
            Live summary from the admin service endpoint.
          </p>
        </div>

        <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {serviceSummaryItems.map(([label, value]) => (
            <div
              key={label}

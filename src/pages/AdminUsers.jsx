        ...
        >
            <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    <span
                        className={`inline-flex w-fit rounded-full px-4 py-2 text-xs font-black uppercase tracking-wide ${user.is_disabled
                            ? isDark
                ...
                <>
                    <section className="mt-6 space-y-4">
                        {paginatedUsers.map((user) => (
                            <UserCard key={user.id} user={user} isDark={isDark} onToggleStatus={handleToggleUserStatus}

...
function HolidayCard({ holiday, isDark, onRemove, isRemoving }) {
    return (
        ...
        >
            <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
                <div className="flex items-start gap-4">
                    ...
                    <div>
                        ...
                        >
                            Observed: {formatDisplayDate(holiday.observed_date || holiday.holiday_date)}
                        </p>

                        {holiday.base_date &&
                            holiday.base_date !== (holiday.observed_date || holiday.holiday_date) && (
                                <p
                                    className={`mt-1 text-xs font-bold ${isDark ? "text-slate-500" : "text-slate-500"
                                        }`}
                                >
                ...
                <button
                    ...
                    className={`inline-flex min-h-10 items-center justify-center gap-2 rounded-full px-4 text-xs font-black uppercase tracking-wide transition disabled:cursor-not-allowed disabled:opacity-60 ${isDark
            ...
            <div
                className={`mt-5 rounded-2xl p-4 ${isDark ? "bg-white/5" : "bg-slate-50"
                    }`}
            >
                <p
                ...
                <p
                    className={`mt-1 text-sm font-black ${isDark ? "text-white" : "text-slate-950"
                        }`}
                >
...
export default function AdminPublicHolidays() {
    ...
    async function handleAddHoliday(event) {
        ...
        if (!holidayDate) {
            alert("Select a public holiday date.");
            return;
        }

        if (!holidayName.trim()) {
            alert("Enter the public holiday name.");
            return;
        }
    ...
    return (
        <DashboardShell>
            ...
            <section
                className={`mt-6 rounded-3xl p-5 sm:p-6 ${isDark
                    ? "border border-white/10 bg-slate-900"
                    : "border border-slate-200 bg-white"
                    }`}
            >
                <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                        ...
                        >
                            Generate fixed and calculated Ghana statutory holidays for a selected
                            year. Eid holidays should still be added manually when officially
                            announced.
                        </p>
                    </div>
                    ...
                    >
                        <input
                            ...
                            className={`min-h-12 rounded-xl border px-4 text-sm font-black outline-none ${isDark
                        ...
                        <button
                            ...
                            className={`inline-flex min-h-12 items-center justify-center rounded-xl px-5 text-sm font-black transition disabled:cursor-not-allowed disabled:opacity-60 ${isDark
            ...
            >
                ...
                >
                    ...
                    <input
                        ...
                        className={`min-h-12 rounded-xl border px-4 text-sm font-semibold outline-none ${isDark
